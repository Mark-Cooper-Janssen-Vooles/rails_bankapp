...
class BankDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_detail" do
    assert_difference('BankDetail.count') do
      post bank_details_url, params: { bank_detail: { account_number: @bank_detail.account_number, bsb: @bank_detail.bsb } }
    end
  ...
  test "should update bank_detail" do
    patch bank_detail_url(@bank_detail), params: { bank_detail: { account_number: @bank_detail.account_number, bsb: @bank_detail.bsb } }
